...
public class EasyGame extends AppCompatActivity {
    ...
    private TypeChart effectiveness = new TypeChart();
    private ArrayList<Button> switchs = new ArrayList<>();

    ////////////////////////////////////////////////////////////////////////////////////////
    ///////////ON APP CREATION(CALLED BY DIFSELECTION)/////////////////////////////////////
    @Override
    ...
    ////////////////////////////////////////////////////////////////////////////////////////
    ///////////UPDATING BUTTONS HUGE FUNCTION///////////////////////////////////////////////
    public void updateButtons() {
        ...
        if (pokemonGame.getPlayer1().getConsciousPokemon().isEmpty()) {
            textView.setText(pokemonGame.getPlayer1().getActivePokemon().getName() + " - " + pokemonGame.getPlayer1().getActivePokemon().getHp()+" HP - "+ pokemonGame.getPlayer1().getActivePokemon().getType());
            textView2.setText(pokemonGame.getPlayer2().getActivePokemon().getName() + " - " + pokemonGame.getPlayer2().getActivePokemon().getHp()+" HP\n"+ pokemonGame.getPlayer2().getActivePokemon().getType());
            text = "Player 2 WINS\nYou LOST";
            textView3.setText(text);
            return;
        ...
        ////////////////////NOT CHANGING TO FAINTED POKEMON//////////////////////////////////////
        ...
        //////////////////////POP-UP FOR SWITCHING PLAYER FAINTED POKEMON//////////////////////////
        if(!pokemonGame.getPlayer1().getActivePokemon().isConscious()){
            ...
            builder.setItems(activepokemon, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    Toast.makeText(EasyGame.this, "You selected " + pokemonGame.getPlayer1().getTeam()[Integer.parseInt(selectedPokemonName)].getName(), Toast.LENGTH_SHORT).show();
                    for (int i = 0; i < pokemonGame.getPlayer1().getTeam().length; i++) {
                    ...
                    showString();
                    ////////////////////////////////////////////////////////////////////////////////////////
                    ///////UPDATING POKEMON NAMES AND POKEMON ATTACKS/////////////////////////////////////
                    textView.setText(pokemonGame.getPlayer1().getActivePokemon().getName() + " - " + pokemonGame.getPlayer1().getActivePokemon().getHp()+" HP - "+ pokemonGame.getPlayer1().getActivePokemon().getType());
                    textView2.setText(pokemonGame.getPlayer2().getActivePokemon().getName() + " - " + pokemonGame.getPlayer2().getActivePokemon().getHp()+" HP\n"+ pokemonGame.getPlayer2().getActivePokemon().getType());
                    attack1.setText(pokemonGame.getPlayer1().getActivePokemon().getAttacks()[0].getName()+"\n"+pokemonGame.getPlayer1().getActivePokemon().getAttacks()[0].getType()+"\nX"+effectiveness.getEffectiveness(pokemonGame.getPlayer1().getActivePokemon().getAttacks()[0].getType(),pokemonGame.getPlayer2().getActivePokemon().getType()));
                    attack1.setBackgroundColor(Color.parseColor(pokemonGame.getPlayer1().getActivePokemon().getAttacks()[0].getType().getColor()));
                    attack2.setText(pokemonGame.getPlayer1().getActivePokemon().getAttacks()[1].getName()+"\n"+pokemonGame.getPlayer1().getActivePokemon().getAttacks()[1].getType()+"\nX"+effectiveness.getEffectiveness(pokemonGame.getPlayer1().getActivePokemon().getAttacks()[1].getType(),pokemonGame.getPlayer2().getActivePokemon().getType()));
                    attack2.setBackgroundColor(Color.parseColor(pokemonGame.getPlayer1().getActivePokemon().getAttacks()[1].getType().getColor()));
                    attack3.setText(pokemonGame.getPlayer1().getActivePokemon().getAttacks()[2].getName()+"\n"+pokemonGame.getPlayer1().getActivePokemon().getAttacks()[2].getType()+"\nX"+effectiveness.getEffectiveness(pokemonGame.getPlayer1().getActivePokemon().getAttacks()[2].getType(),pokemonGame.getPlayer2().getActivePokemon().getType()));
                    attack3.setBackgroundColor(Color.parseColor(pokemonGame.getPlayer1().getActivePokemon().getAttacks()[2].getType().getColor()));
                    attack4.setText(pokemonGame.getPlayer1().getActivePokemon().getAttacks()[3].getName()+"\n"+pokemonGame.getPlayer1().getActivePokemon().getAttacks()[3].getType()+"\nX"+effectiveness.getEffectiveness(pokemonGame.getPlayer1().getActivePokemon().getAttacks()[3].getType(),pokemonGame.getPlayer2().getActivePokemon().getType()));
                    attack4.setBackgroundColor(Color.parseColor(pokemonGame.getPlayer1().getActivePokemon().getAttacks()[3].getType().getColor()));
                    ////////////////////////////////////////////////////////////////////////////////////////
                    ///////////UPDATING POKEMON GIFS///////////////////////////////////////////////
    ...
    public void showString() {
        ...
        //       historymsg.append(turn).append("\n");
        String aux = String.join("\n", message);
        //     historymsg.append(message).append(("\n"));
        String result = turn + ":\n" + aux;
